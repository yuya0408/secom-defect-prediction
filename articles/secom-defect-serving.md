---
title: "精度に限界のあるモデルでも、動く形にする ― SECOM分析を推論APIにするまで（実装編）"
emoji: "🛠️"
type: "tech"
...
:::message
私は元・電子部品メーカーの製造技術職で、現在はIT業界に転じてエンジニア歴1年未満。MLOpsの専門家ではない。この記事は「現場で使われる形にするには何が要るのか」を、製造業出身者なりに手を動かして確かめた記録であり、ベストプラクティスの教科書ではない。
:::
